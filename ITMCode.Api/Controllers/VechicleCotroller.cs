...
namespace ITMCode.Piatnica.Api.Controllers
{
    ...
    public class VechicleController : ControllerBase
    {
        ...
        public VechicleController(IServiceFactory serviceFactory, IMapper mapper)
        {
        ...
        {
            var delay = await _serviceFactory.VechicleService.GetAsync(id);
            return Ok(_mapper.Map<VechicleApiModel>(delay));
        }
        ...
        //    //var delayResult = await _serviceFactory.VechicleService.AddAsync(delay.DelayOrder);
        ...
        //    //await _serviceFactory.VechicleService.UpdateAsync(id, delayBll);
        ...
        //{
        //    //await _serviceFactory.VechicleService.DeleteAsync(id);
